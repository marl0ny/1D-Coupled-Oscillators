...
class Simulation {
    ...
    MetropolisResultInfo compute_coherent_state_configurations(
        const SimParams &sim_params);
    MetropolisResultInfo compute_squeezed_state_configurations(
        const SimParams &sim_params);
    MetropolisResultInfo compute_stationary_state_configurations(
        const SimParams &sim_params);
    MetropolisResultInfo compute_single_excitations_configurations(
        const SimParams &sim_params);
    ...
    Simulation(const SimParams &sim_params,
        int view_width, int view_height);
    MetropolisResultInfo compute_configurations(const SimParams &sim_params);
