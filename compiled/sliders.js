...
createScalarParameterSlider(controls, 11, "Number of Monte Carlo samples", "int", {'value': 1000, 'min': 10, 'max': 100000});
createLineDivider(controls);
...
createSelectionList(controls, 17, 0, "Plot type", [ "Lines",  "Scatter",  "Multi-coloured histogram"]);
